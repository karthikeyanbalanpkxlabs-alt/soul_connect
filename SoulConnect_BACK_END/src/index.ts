...
async function handleSubscriptionCreate(req: Request, res: Response) {
  try {
...
async function handleSubscriptionEdit(req: Request, res: Response) {
  try {
...
app.post("/api/subscription/create", keycloak.protect(), handleSubscriptionCreate);
app.post("/api/subscription/edit", keycloak.protect(), handleSubscriptionEdit);
app.get(
...
app.post("/api/public/subscription/create", handleSubscriptionCreate);
app.post("/api/public/subscription/edit", handleSubscriptionEdit);
