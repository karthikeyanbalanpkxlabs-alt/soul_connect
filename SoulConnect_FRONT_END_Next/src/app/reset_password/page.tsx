...
function ResetPasswordForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (newPassword !== confirmPassword) {
      setFieldError("Passwords do not match. Please verify.");
      return;
    }
    ...
    try {
      const endpoint = `${configUrls.apiUrl}/api/public/reset-password`;
      ...
      <div style={{ marginTop: "12px" }}>
        ...
        <div className="sc-auth-subtitle">
          {isSuccess
            ...
            : `Please enter a new password below for ${emailParam ? emailParam : "your account"}.`}
        </div>
      </div>

      {/* NEGATIVE FLOW: SERVER / TOKEN ERROR */}
      {errorMsg && (
        <div
      ...
      {isSuccess ? (
        ...
        <form onSubmit={handleSubmit} noValidate style={{ marginTop: "24px" }}>
          <div className="sc-form-group">
            <label className="sc-form-label" htmlFor="newPassword">
              New Password
            </label>
            <div className="sc-form-input-wrap">
              ...
              />
              <span
                className="sc-form-input-suffix"
          ...
          <div className="sc-form-group" style={{ marginTop: "16px" }}>
            <label className="sc-form-label" htmlFor="confirmPassword">
