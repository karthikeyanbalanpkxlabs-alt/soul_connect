...
const customerValidationSchema = Yup.object().shape({
  whoiam_register: Yup.string().required(
    "Please select who you are registering for",
  ),
...
export default function CustomerModal({
    ...
    initialValues: initialData
      ? {
          ...
          horoscopeDetails: {
            ...
            lagnam:
              initialData.horoscopeDetails?.lagnam || initialData.lagnam || "",
            gothram:
              initialData.horoscopeDetails?.gothram ||
              initialData.gothram ||
              "",
            ...
            dosham:
              initialData.horoscopeDetails?.dosham ||
              initialData.dosham ||
              "No Dosham",
            manglik:
              initialData.horoscopeDetails?.manglik ||
              initialData.manglik ||
              "No",
            chevvai_dosham:
              initialData.horoscopeDetails?.chevvai_dosham ||
              initialData.chevvai_dosham ||
              "No",
            rahu_ketu_dosham:
              initialData.horoscopeDetails?.rahu_ketu_dosham ||
              initialData.rahu_ketu_dosham ||
              "Neutral",
            jathagam:
              initialData.horoscopeDetails?.jathagam ||
              initialData.jathagam ||
              null,
          },
          familyBackground: {
            ...
            father_name:
              initialData.familyBackground?.father_name ||
              initialData.father_name ||
              "",
            father_occupation:
              initialData.familyBackground?.father_occupation ||
              initialData.father_occupation ||
              "",
            mother_name:
              initialData.familyBackground?.mother_name ||
              initialData.mother_name ||
              "",
            mother_occupation:
              initialData.familyBackground?.mother_occupation ||
              initialData.mother_occupation ||
              "",
            siblings:
              initialData.familyBackground?.siblings ||
              initialData.siblings ||
              "",
            siblings_details:
              initialData.familyBackground?.siblings_details ||
              initialData.siblings_details ||
              "",
            family_type:
              initialData.familyBackground?.family_type ||
              initialData.family_type ||
              "",
            family_type_details:
              initialData.familyBackground?.family_type_details ||
              initialData.family_type_details ||
              "",
            family_status:
              initialData.familyBackground?.family_status ||
              initialData.family_status ||
              "",
            family_status_details:
              initialData.familyBackground?.family_status_details ||
              initialData.family_status_details ||
              "",
            family_address:
              initialData.familyBackground?.family_address ||
              initialData.family_address ||
              "",
            family_values:
              initialData.familyBackground?.family_values ||
              initialData.family_values ||
              "",
            family_values_details:
              initialData.familyBackground?.family_values_details ||
              initialData.family_values_details ||
              "",
            about_family:
              initialData.familyBackground?.about_family ||
              initialData.about_family ||
              "",
            about_family_tamil:
              initialData.familyBackground?.about_family_tamil ||
              initialData.about_family_tamil ||
              "",
          },
          lifeStyle: {
            ...
            smoking:
              initialData.lifeStyle?.smoking || initialData.smoking || "",
            drinking:
              initialData.lifeStyle?.drinking || initialData.drinking || "",
            living_with:
              initialData.lifeStyle?.living_with ||
              initialData.living_with ||
              "",
            willing_to_relocate:
              initialData.lifeStyle?.willing_to_relocate ||
              initialData.willing_to_relocate ||
              "",
            interests:
              initialData.lifeStyle?.interests || initialData.interests || "",
          },
          partnerPreferencesDetails: {
            ...defaultFormData.partnerPreferencesDetails,
            ...(initialData.partnerPreferencesDetails || {}),
            overview:
              initialData.partnerPreferencesDetails?.overview ||
              initialData.partner_preference ||
              "",
          },
  ...
  const getInputClassName = (fieldName: keyof typeof defaultFormData) => {
    ...
    return `w-full px-4 py-2 border rounded-sm outline-none transition-colors bg-gray-50 focus:bg-white disabled:bg-gray-100 disabled:text-gray-600 disabled:cursor-not-allowed disabled:border-gray-200 ${
      isInvalid
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-[95vw] xl:max-w-[92vw] 2xl:max-w-[85vw] max-h-[92vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          >
            <fieldset
              disabled={!isManager}
              className="border-none p-0 m-0 min-w-0 space-y-6 [&_input:disabled]:bg-gray-100 [&_input:disabled]:text-gray-600 [&_input:disabled]:cursor-not-allowed [&_input:disabled]:border-gray-200 [&_select:disabled]:bg-gray-100 [&_select:disabled]:text-gray-600 [&_select:disabled]:cursor-not-allowed [&_select:disabled]:border-gray-200 [&_textarea:disabled]:bg-gray-100 [&_textarea:disabled]:text-gray-600 [&_textarea:disabled]:cursor-not-allowed [&_textarea:disabled]:border-gray-200"
            >
              {/* Image Upload */}
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-4">
                  {validImages.map((img: any, index: number) => (
                    ...
                    >
                      ...
                      />
                      {img.default && (
                        <span className="absolute top-1 left-1 bg-amber-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded shadow z-10">
                          ★ Default
                        </span>
                      )}
                      {isManager && (
                  ...
                  {isManager && validImages.length < 5 && (
                  ...
                  {!isManager && validImages.length === 0 && (
                    <p className="text-xs text-gray-400 italic py-2">
                      No profile images uploaded
                    </p>
                  )}
                </div>
                {isManager && renderFieldError("image")}
              </div>
              ...
              <div className="mb-8 p-6 bg-white rounded-2xl border border-gray-200/80 shadow-sm">
                ...
                <div className="flex flex-wrap gap-4">
                  {(() => {
                    ...
                    return (
                      <div className="w-44 h-60 rounded-2xl border border-dashed border-slate-200 flex items-center justify-center text-xs text-slate-400 italic">
                        No family photo uploaded
                      </div>
                    );
                  })()}
                </div>
                {isManager && renderFieldError("family_photos" as any)}
              </div>
              ...
              <div className="mb-8">
                ...
                />
                {isManager && renderFieldError("ambition")}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 gap-6">
                ...
                <div className="sm:col-span-2 md:col-span-3 lg:col-span-4 2xl:col-span-5 mb-2">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {[
                      ...
                      {
                        id: "daughter",
                        label: "For my daughter",
                        icon: "👧",
                        gender: "Female",
                      },
                    ].map((opt) => {
                      const isSelected =
                        formik.values.whoiam_register === opt.label;
                      return (
                        <button
                          key={opt.id}
                          type="button"
                          ...
                          } ${!isManager ? "cursor-not-allowed opacity-80" : "cursor-pointer"}`}
                        >
                  ...
                  {isManager && renderFieldError("whoiam_register")}
                </div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        (typeof formik.values.health_report === "string"
                          ...
                          (() => {
                            ...
                            const url =
                              typeof report === "string" ? report : report.url;
                            const name =
                ...
                <div className="sm:col-span-2 md:col-span-3 lg:col-span-4 2xl:col-span-5 border-t pt-6 mt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        value={
                          formik.values.horoscopeDetails?.dosham || "No Dosham"
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                        className="w-full px-4 py-2 border rounded-sm outline-none transition-colors bg-gray-50 focus:bg-white border-gray-300 focus:border-violet-500 text-sm"
                    ...
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        value={
                          formik.values.horoscopeDetails?.chevvai_dosham || "No"
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                        className="w-full px-4 py-2 border rounded-sm outline-none transition-colors bg-gray-50 focus:bg-white border-gray-300 focus:border-violet-500 text-sm"
                    ...
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        value={
                          formik.values.horoscopeDetails?.rahu_ketu_dosham ||
                          "Neutral"
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                  ...
                  <div className="mt-4 space-y-1">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      (typeof formik.values.horoscopeDetails.jathagam ===
                      "string"
                        ? formik.values.horoscopeDetails.jathagam
                  ...
                  <div className="flex items-center gap-2 border-b border-slate-200 pb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        Father, Mother, Siblings, Family Status, Values &
                        Address details
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.familyBackground?.father_name || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.familyBackground?.father_occupation ||
                          ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.familyBackground?.mother_name || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.familyBackground?.mother_occupation ||
                          ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.familyBackground?.siblings_details || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.familyBackground?.family_type || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.familyBackground?.family_type_details ||
                          ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.familyBackground?.family_status || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.familyBackground
                            ?.family_status_details || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.familyBackground?.family_address || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.familyBackground?.family_values || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div className="sm:col-span-2 md:col-span-3 lg:col-span-4">
                      ...
                      <textarea
                        ...
                        rows={2}
                        value={
                          formik.values.familyBackground?.about_family || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.lifeStyle?.willing_to_relocate || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                ...
                <div className="mt-8 pt-6 border-t border-gray-100 sm:col-span-2 md:col-span-3 lg:col-span-4 2xl:col-span-5">
                  <h3 className="text-base font-bold text-gray-800 mb-4 flex items-center gap-2">
                    <span className="text-xl">💖</span> Partner Preferences
                    Details
                  </h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {/* Age Range */}
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.partnerPreferencesDetails?.age_range ||
                          ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.partnerPreferencesDetails?.height || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.partnerPreferencesDetails
                            ?.marital_status || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.partnerPreferencesDetails?.diet || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.partnerPreferencesDetails?.education ||
                          ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.partnerPreferencesDetails?.occupation ||
                          ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.partnerPreferencesDetails?.income || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.partnerPreferencesDetails?.religion ||
                          ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.partnerPreferencesDetails?.caste || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.partnerPreferencesDetails?.location ||
                          ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={
                          formik.values.partnerPreferencesDetails?.values || ""
                        }
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <div className="sm:col-span-2 md:col-span-3 lg:col-span-4">
                      ...
                      <textarea
                        ...
                        rows={2}
                        value={
                          formik.values.partnerPreferencesDetails?.overview ||
                          ""
                        }
                        onChange={(e) => {
        ...
        <div className="p-6 border-t bg-gray-50 rounded-b-xl flex justify-end gap-3">
          <button
            type="button"
            onClick={onClose}
            className="px-6 py-2 border border-gray-300 rounded-sm text-gray-700 font-medium hover:bg-gray-100 transition-colors cursor-pointer"
          >
            Cancel
          </button>
          <button
            form="customer-form"
            type="submit"
            className="px-6 py-2 bg-violet-600 rounded-sm text-white font-medium hover:bg-violet-700 transition-colors cursor-pointer"
          >
