  ...
  return (
    <section className="hero">
      ...
      <div className="hero-cards">
        <div className="fc">
          <div className="fc-av" style={{ background: "linear-gradient(135deg, #F2688C, #7C3AED)" }}>A</div>
          <div>
        ...
        <div className="fc">
          <div className="fc-av" style={{ background: "linear-gradient(135deg, #059669, #0D9488)" }}>K</div>
          <div>
        ...
        <div className="fc">
          <div className="fc-av" style={{ background: "linear-gradient(135deg, #D97706, #F59E0B)" }}>P</div>
          <div>
        ...
        <div className="fc">
          <div className="fc-av" style={{ background: "linear-gradient(135deg, #7C3AED, #C0436A)" }}>R</div>
          <div>
      ...
      <div className="hero-badge">🏆 Tamil Nadu's #1 Psychology-Based Matrimony Platform</div>
      
      <h1>Find your <em>soulmate</em> across all of Tamil Nadu</h1>
      
      <p className="hero-sub">
        Deep compatibility matching powered by psychology — not just horoscopes and biodata. 
        All 38 districts, every community, every dream.
      </p>
      <p className="hero-sub-tamil">அனைத்து 38 மாவட்டங்களிலும் உங்கள் வாழ்க்கை துணையை கண்டுபிடியுங்கள்</p>
