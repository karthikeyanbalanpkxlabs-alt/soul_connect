...
<title>Soul Connect – Set New Password</title>
  ...
  <div class="auth-form-side">
    <div class="auth-form-wrap">
      ...
      <div class="reveal" style="transition-delay:.1s">
        ...
        <div class="auth-subtitle">Please enter your new password below to update your account security.</div>
      </div>
      ...
      <form id="kc-passwd-update-form" action="${url.loginAction}" method="post" style="margin-top: 24px;">
        <div class="reveal" style="transition-delay:.22s">
          <div class="form-group">
            <label class="form-label" for="password-new">New Password</label>
            <div class="form-input-wrap">
              <span class="form-input-icon">🔒</span>
              <input id="password-new" name="password-new" type="password" class="form-input" placeholder="Enter new password" autocomplete="new-password" autofocus>
              <span class="form-input-suffix" onclick="togglePwd('password-new')">👁</span>
            </div>
          </div>
          ...
          <div class="form-group" style="margin-top: 16px;">
            ...
            <div class="form-input-wrap">
              <span class="form-input-icon">🔒</span>
              <input id="password-confirm" name="password-confirm" type="password" class="form-input" placeholder="Confirm new password" autocomplete="new-password">
              <span class="form-input-suffix" onclick="togglePwd('password-confirm')">👁</span>
            </div>
          </div>
        </div>
